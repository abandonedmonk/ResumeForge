...
def build_semantic_score_prompt(keywords: list[str], resume_bullets: list[str]) -> tuple[str, str]:
    system_prompt = (
        ...
        "through meaningful resume evidence, merely name-dropped, or absent. Return JSON only."
    )
    user_prompt = (
        ...
        "Use name_dropped when the keyword appears but without meaningful evidence.\n"
